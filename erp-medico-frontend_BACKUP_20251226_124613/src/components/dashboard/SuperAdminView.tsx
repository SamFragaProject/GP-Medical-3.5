    ...
    return (
        <div className="min-h-screen bg-slate-50/50 p-6 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                    { title: 'Empresas', icon: '🏢', path: '/platform/empresas', color: 'from-blue-500 to-cyan-500' },
                    { title: 'Usuarios', icon: '👥', path: '/platform/usuarios', color: 'from-green-500 to-emerald-500' },
                    { title: 'RRHH', icon: '📋', path: '/platform/rrhh', color: 'from-violet-500 to-purple-500' },
                    { title: 'Configuración', icon: '⚙️', path: '/platform/configuracion', color: 'from-gray-600 to-slate-700' },
                ].map((module) => (
                    <motion.a
                        key={module.title}
                        href={module.path}
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`bg-gradient-to-br ${module.color} rounded-2xl p-5 text-white shadow-lg hover:shadow-xl transition-all cursor-pointer block`}
                    >
