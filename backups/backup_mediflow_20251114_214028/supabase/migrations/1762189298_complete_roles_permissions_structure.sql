-- Migration: complete_roles_permissions_structure
-- Created at: 1762189298
...
-- Agregar columnas faltantes a tabla usuarios_roles
ALTER TABLE usuarios_roles 
ADD COLUMN IF NOT EXISTS asignado_por uuid REFERENCES usuarios_perfil(id),
ADD COLUMN IF NOT EXISTS fecha_asignacion TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
