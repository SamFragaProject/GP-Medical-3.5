...
export function Pacientes() {
  ...
  const canManagePatientsPermission = useRequirePermission('manage_patients')
  const canViewMedicalHistoryPermission = useRequirePermission('view_medical_history')
  ...
  if (!canManagePatientsPermission) {
    return (
        ...
        <div className="max-w-md mx-auto text-center">
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              No tienes permisos para gestionar pacientes.
              <br /><br />
              <span className="text-sm text-gray-600">
                Rol actual: <strong>{user?.hierarchy || 'No definido'}</strong>
              </span>
            </AlertDescription>
          </Alert>
          <button
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    {/* Botón ver siempre visible para usuarios autorizados */}
                    {canViewMedicalHistoryPermission && (
                      <Button
                        variant="outline"
                        size="sm"
                    ...
                    {/* Botones de edición y eliminación solo para usuarios con permisos */}
                    {canManagePatientsPermission && (
                      <>
