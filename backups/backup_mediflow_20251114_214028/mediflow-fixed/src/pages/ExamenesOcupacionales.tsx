...
import { useRequirePermission } from '@/components/ProtectedRoute'
...
export function ExamenesOcupacionales() {
  ...
  const canManageExams = useRequirePermission('manage_exams')
  const canViewMedicalHistory = useRequirePermission('view_medical_history')
        ...
        <div className="max-w-md mx-auto text-center">
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              Los pacientes no pueden acceder al módulo de exámenes ocupacionales.
              <br /><br />
              <span className="text-sm text-gray-600">
                Para ver tus resultados, contacta a tu médico tratante.
              </span>
            </AlertDescription>
          </Alert>
          <button
  ...
  // Función para verificar jerarquías
  const hasAnyRole = (hierarchies: string[]) => {
    if (!user?.hierarchy) return false
    return hierarchies.includes(user.hierarchy)
  }

  // Verificar permisos para gestionar exámenes
  if (!hasAnyRole(['admin_empresa', 'medico_trabajo', 'medico_industrial']) && !canManageExams) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white to-green-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              No tienes permisos para gestionar exámenes ocupacionales.
              <br /><br />
              <span className="text-sm text-gray-600">
                Jerarquía actual: <strong>{user?.hierarchy}</strong>
              </span>
            </AlertDescription>
          </Alert>
          <button
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{estadisticas.totalExamenes}</p>
            </div>
        ...
        <motion.div 
          ...
          className="bg-white rounded-lg shadow-md p-6 border-l-4 border-success"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Realizados Hoy</p>
              <p className="text-3xl font-bold text-success">{estadisticas.realizadosHoy}</p>
            </div>
        ...
        <motion.div 
          ...
          className="bg-white rounded-lg shadow-md p-6 border-l-4 border-warning"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Próximos a Vencer</p>
              <p className="text-3xl font-bold text-warning">{estadisticas.proximosVencer}</p>
            </div>
        ...
        <motion.div 
          ...
          className="bg-white rounded-lg shadow-md p-6 border-l-4 border-danger"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Vencidos</p>
              <p className="text-3xl font-bold text-danger">{estadisticas.vencidos}</p>
            </div>
        ...
        <div className="px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Exámenes Ocupacionales</h1>
                <p className="text-gray-600">Gestión completa de exámenes médicos laborales</p>
              </div>
            </div>
