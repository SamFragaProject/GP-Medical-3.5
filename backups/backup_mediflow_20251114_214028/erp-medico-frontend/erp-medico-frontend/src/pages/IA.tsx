...
export function IA() {
  ...
  // Datos simulados del motor de IA
  useEffect(() => {
    cargarDatosIA()
  }, [])
  ...
  const cargarDatosIA = () => {
    ...
    const insightsSimulados: AIInsight[] = [
      ...
      },
      {
        id: '3',
        tipo: 'oportunidad',
        titulo: 'Optimización de Protocolos de Seguridad',
        descripcion: 'El análisis predictivo sugiere mejoras en el protocolo de seguridad industrial.',
        prioridad: 3,
        accion_recomendada: 'Revisar y actualizar protocolo de emergencia',
        impacto_estimado: 'Medio - Reducción de riesgos operacionales',
        porcentaje_confianza: 92.1,
        fecha_generacion: new Date().toISOString()
      }
    ]
    ...
    const scoresSimulados = {
      ...
      'ausentismo': { riesgo: 28, confianza: 91.2, tendencia: 'estable' as const },
      'lesiones': { riesgo: 15, confianza: 96.8, tendencia: 'bajando' as const },
      'estres': { riesgo: 45, confianza: 88.9, tendencia: 'subiendo' as const },
      'capacitacion': { riesgo: 22, confianza: 87.5, tendencia: 'estable' as const }
    }
  ...
  const refreshAI = async () => {
    setLoading(true)
    toast.loading('Actualizando análisis de IA...', { id: 'ai-refresh' })
    
    // Simular actualización del motor de IA
    setTimeout(() => {
      setLoading(false)
      toast.success('Análisis de IA actualizado correctamente', { id: 'ai-refresh' })
      cargarDatosIA()
    }, 2000)
  }
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-gray-900 flex items-center">
            ...
            Motor de IA - Medicina del Trabajo
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-600">Precisión</p>
                <p className="text-2xl font-bold text-blue-900">{systemHealth.precision}%</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-600">Velocidad</p>
                <p className="text-2xl font-bold text-green-900">{systemHealth.velocidad}%</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-600">Cobertura</p>
                <p className="text-2xl font-bold text-purple-900">{systemHealth.cobertura}%</p>
              </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-600">Última Actualización</p>
                <p className="text-sm font-bold text-orange-900">{systemHealth.actualizaciones}</p>
              </div>
                      ...
                      <div className="w-20 bg-gray-200 rounded-full h-2">
                        <div 
                          className={`h-2 rounded-full ${
                            empleado.urgencia === 'alta' ? 'bg-red-500' :
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-primary to-secondary rounded-xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">Sistema de IA Médica</h1>
            <p className="text-primary-100">
              Motor de inteligencia artificial especializado en medicina del trabajo
            </p>
          </div>
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                            modelo.activo ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                          }`}>
