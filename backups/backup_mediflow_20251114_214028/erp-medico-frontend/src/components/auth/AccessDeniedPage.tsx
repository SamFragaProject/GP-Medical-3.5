// Página de error personalizada para acceso denegado - SIMPLIFICADO PARA DEMO
...
export function AccessDeniedPage({
  ...
  // ACCESO DIRECTO - Para demo, esta página no debería mostrarse nunca
      ...
      >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <p className="text-gray-900">
                          {displayUser.empresa?.nombre || 'MediFlow Demo Corp'}
                        </p>
                      </div>
                      <div className="md:col-span-2">
                        <span className="font-medium text-gray-700 flex items-center">
                        ...
                        <p className="text-gray-900">
                          {displayUser.sede?.nombre || 'Sede Principal'}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="bg-blue-50 p-4 rounded-lg mb-6">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• Esta página no debería mostrarse en el modo demo</li>
            <li>• Contacta al administrador del sistema si persiste el error</li>
            <li>• Verifica que estés usando el usuario correcto</li>
