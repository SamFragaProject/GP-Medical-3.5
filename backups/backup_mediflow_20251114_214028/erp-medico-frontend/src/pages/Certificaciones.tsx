  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Certificaciones Médicas</h1>
          <p className="text-gray-600 mt-1">Gestión completa de certificaciones laborales</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{certificaciones.length}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-success">
                {certificaciones.filter(c => c.estado === 'vigente').length}
              </p>
            </div>
          ...
          <div className="mt-4 flex items-center">
            ...
            <span className="text-gray-500 text-sm ml-2">sin vencimientos</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mt-4 flex items-center">
            <span className="text-warning text-sm font-medium">Alertas activas</span>
            <span className="text-gray-500 text-sm ml-2">30 días</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mt-4 flex items-center">
            <span className="text-primary text-sm font-medium">Integradas</span>
            <span className="text-gray-500 text-sm ml-2">al sistema</span>
          </div>
        </motion.div>
      </div>
