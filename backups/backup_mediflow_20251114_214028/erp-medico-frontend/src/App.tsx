...
// Aplicación sin autenticación - Acceso directo a todas las funcionalidades

// Aplicación simplificada sin autenticación - Acceso directo al Dashboard
        ...
        <Router>
          <div className="App">
            <Routes>
              ...
              {/* Módulos principales - Acceso directo sin protecciones */}
              <Route 
                path="/pacientes" 
                element={
                  <Layout>
