...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "text/css", "application/javascript"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for public-assets" ON storage.objects FOR SELECT USING (bucket_id = 'public-assets');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for public-assets" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'public-assets');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for public-assets" ON storage.objects FOR UPDATE USING (bucket_id = 'public-assets');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for public-assets" ON storage.objects FOR DELETE USING (bucket_id = 'public-assets');`
    ];
