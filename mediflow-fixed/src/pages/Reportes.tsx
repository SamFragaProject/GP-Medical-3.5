...
export function Reportes() {
  ...
  const vistas = [
    { id: 'dashboard', nombre: 'Dashboard Principal', icon: BarChart3, color: 'bg-blue-500' },
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Análisis avanzado de salud ocupacional con IA</p>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 transition-colors flex items-center space-x-2 font-medium text-sm shadow-sm"
              >
                <FileText size={16} />
              ...
              <button
                ...
                className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-600/90 transition-colors flex items-center space-x-2 font-medium text-sm shadow-sm"
              >
                <Download size={16} />
                <span>Exportar</span>
              </button>
