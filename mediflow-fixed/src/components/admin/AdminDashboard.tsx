...
export function AdminDashboard() {
  ...
  if (!currentUser || currentUser.hierarchy !== 'super_admin') {
    return (
      <div className="p-6">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Monitoreo y control del sistema MediFlow</p>
        </div>
...
// Wrapper con protección de permisos
