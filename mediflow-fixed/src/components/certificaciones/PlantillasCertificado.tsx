                      ...
                      <div key={plantilla.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex items-center space-x-1">
                            {plantilla.esDefecto && (
                              <Star className="h-4 w-4 text-yellow-500" title="Plantilla por defecto" />
                            )}
                            <button
                ...
                <div className="flex items-center space-x-1 bg-gray-100 rounded-lg p-1">
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded ${
                      editorMode === 'visual' ? 'bg-white shadow-sm' : 'text-gray-600'
                    }`}
                  >
                    Visual
                  </button>
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded ${
                      editorMode === 'html' ? 'bg-white shadow-sm' : 'text-gray-600'
                    }`}
                  >
                    HTML
                  </button>
