// Layout principal del ERP Médico - SIN AUTENTICACIÓN
...
export function Layout({ children }: LayoutProps) {
  ...
  // Usuario demo para el sistema sin autenticación
  const currentUser = {
    id: 'demo-user',
    name: 'Usuario Demo',
  ...
  // Nueva cita - siempre permitido
  const handleNewAppointment = () => {
    navigate('/dashboard/agenda/nueva')
    toast.success('Abriendo formulario de nueva cita')
  }

  // Logout - no hace nada en modo demo
  const handleLogout = () => {
    toast.success('Modo demo - no hay sesión que cerrar')
  }
                ...
                <AnimatePresence>
                  {showUserMenu && (
                    ...
                    >
                      ...
                      {currentUser?.hierarchy === 'super_admin' && (
                        <>
