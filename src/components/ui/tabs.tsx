// Componente Tabs de shadcn/ui personalizado para el ERP Médico
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-2xl bg-slate-100/50 p-1.5 text-slate-500 backdrop-blur-md border border-slate-200/50 shadow-inner",
      className
    )}
    {...props}
  />
