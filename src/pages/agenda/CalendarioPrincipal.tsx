      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="p-2 hover:bg-emerald-100 text-emerald-600 rounded-xl transition-all active:scale-90"
          >
            <ChevronLeft size={20} />
          </button>
          <button
            onClick={() => onNavigate('TODAY')}
            className="px-4 py-1.5 text-sm font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 rounded-xl transition-all active:scale-95 shadow-sm border border-emerald-100"
          >
            Hoy
          </button>
          <button
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center bg-white rounded-lg border border-gray-200 p-1">
          <button
            ...
            className={`px-3 py-1 text-sm font-medium rounded transition-colors ${view === 'month' ? 'bg-primary text-white' : 'text-gray-600 hover:text-gray-900'
              }`}
          >
            Mes
          </button>
          <button
            onClick={() => onView('week')}
            className={`px-3 py-1 text-sm font-medium rounded transition-colors ${view === 'week' ? 'bg-primary text-white' : 'text-gray-600 hover:text-gray-900'
              }`}
          >
            Semana
          </button>
          <button
            onClick={() => onView('day')}
            className={`px-3 py-1 text-sm font-medium rounded transition-colors ${view === 'day' ? 'bg-primary text-white' : 'text-gray-600 hover:text-gray-900'
              }`}
          >
            Día
          </button>
        ...
        <button
          ...
          className="btn-premium px-5 py-2.5 flex items-center space-x-2 text-sm"
        >
          <Plus size={18} />
