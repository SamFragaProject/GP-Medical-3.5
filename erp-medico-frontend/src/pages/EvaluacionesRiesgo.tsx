  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <PremiumHeader
          title="Evaluaciones de Riesgo Ergonómico"
          subtitle="Análisis integral de riesgos ergonómicos y mediciones ambientales"
          gradient={true}
          badges={[
            { text: "Sistema Activo", variant: "success", icon: <ShieldCheck size={14} /> }
          ]}
        />
        <div className="flex space-x-3">
          <button
            onClick={() => setVistaActual('dashboard')}
            className={`px-4 py-2 rounded-xl transition-all duration-200 flex items-center space-x-2 ${vistaActual === 'dashboard'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl transition-all duration-200 flex items-center space-x-2 ${vistaActual === 'lista'
              ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/30'
              : 'bg-white border border-gray-200 text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl transition-all duration-200 flex items-center space-x-2 ${vistaActual === 'ia'
              ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg shadow-blue-500/30'
              : 'bg-white border border-gray-200 text-gray-700 hover:bg-gray-50'
              }`}
          >
