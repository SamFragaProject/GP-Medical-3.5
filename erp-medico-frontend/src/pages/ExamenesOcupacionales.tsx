...
export function ExamenesOcupacionales() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-green-50">
      {/* Header del módulo - Premium */}
      <div className="p-6">
        <PremiumHeader
          title="Exámenes Ocupacionales"
          subtitle="Gestión completa de exámenes médicos laborales"
          gradient={true}
          badges={[
            { text: "3 Alertas", variant: "danger", icon: <Bell size={14} /> }
          ]}
        />

        <div className="mt-6 flex justify-end space-x-4">
          <button className="flex items-center space-x-2 bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-xl hover:bg-gray-50 transition-all duration-200 shadow-sm">
            <Download size={16} />
